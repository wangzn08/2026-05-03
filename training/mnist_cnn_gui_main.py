...
def qimage_to_pil(qimage):
    ...
    pil_img = Image.frombuffer("RGBA", (qimage.width(), qimage.height()), buffer, "raw", "RGBA", qimage.bytesPerLine(), 1)
    return pil_img
...
def pil_to_qimage(pil_img):
    ...
    return qimage.copy()  # copy to keep data reference
    ...
    def pbtPredict_Callback(self):
        ...
        if self.mode == MODE_MNIST:
            ...
            if __img == None:   # 无图像则用纯黑代替
                ...
                __img = QImage(224, 224, QImage.Format.Format_Grayscale8)
